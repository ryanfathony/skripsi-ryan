...
class IPAManagement extends CI_Controller
{
    ...
    {
        $data['title'] = 'Criteria IPA';
        $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();

        $this->load->model('Moora_model');
        $data['model'] = $this->Moora_model->joinTableIPA();
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('ipa/criteria', $data);
            ...
            $this->db->insert('dss_criteria_ipa', $data);
    ...
    public function criteriaDelete($criteria_id)
    {
        ...
        $this->db->delete('dss_criteria_ipa');
    ...
    {
        $data['title'] = 'Edit Criteria IPA';
        $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();

        $data['criteria'] = $this->db->get_where('dss_criteria_ipa', ['id' => $criteria_id])->row_array();
        $data['attribute'] = $this->db->get('attribute_type')->result_array();
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('template/sidebar', $data);
            $this->load->view('template/topbar', $data);
            $this->load->view('ipa/edit-criteria', $data);
            $this->load->view('template/footer');
        } else {
            $data = [
            ...
            $this->db->update('dss_criteria_ipa', $data);
    ...
    public function criteriaForm()
    {
        ...
        $this->load->view('template/sidebar', $data);
        $this->load->view('template/topbar', $data);
        $this->load->view('ipa/form-criteria', $data);
        $this->load->view('template/footer');
    }
    ...
    {
        $data['title'] = 'IPA Assessment';
        $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();

        $this->load->model('Moora_model');
        $data['assessment'] = $this->Moora_model->joinAssessmentIPA();

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('template/topbar', $data);
        $this->load->view('ipa/assessment', $data);
        $this->load->view('template/footer');
    }
    ...
    public function assessmentDelete($assessment_id)
    {
        ...
        $this->db->delete('dss_assessment_ipa');
    ...
    public function assessmentEdit($assessment_id)
    {
        ...
        $data['assessment'] = $this->db->get_where('dss_assessment_ipa', ['id' => $assessment_id])->row_array();
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('template/sidebar', $data);
            $this->load->view('template/topbar', $data);
            $this->load->view('ipa/edit-assessment', $data);
            $this->load->view('template/footer');
        } else {
            $data = [
            ...
            $this->db->where('id', $this->input->post('id'));
            $this->db->update('dss_assessment_ipa', $data);
    ...
    public function assessmentForm()
    {
        ...
        $this->load->view('template/sidebar', $data);
        $this->load->view('template/topbar', $data);
        $this->load->view('ipa/form-assessment', $data);
        $this->load->view('template/footer');
    }
    ...
    {
        $data['title'] = 'IPA Moora Result';
        $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();

        $this->load->model('Moora_model');
        $data['data'] = $this->Moora_model->getJoinIpa();

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('template/topbar', $data);
        $this->load->view('ipa/result-moora', $data);
        $this->load->view('template/footer');
    }
    ...
    public function getResultMoora()
    {
        ...
        $this->db->empty_table('dss_moora_ipa');

        $criteria = $this->db->get('dss_criteria_ipa');
        ...
        foreach ($criteria->result() as $value) {
            ...
            foreach ($this->Moora_model->get('dss_assessment', array('code_criteria' => $value->code_criteria))->result() as $v) {
                //var_dump($v);
                $powed += pow($v->value, 2); //mepangkatkan 2 untuk setiap value pow (pangkat)
            }
            //var_dump($powed);
        ...
        foreach ($alternative->result() as $v) {
            ...
            $this->db->insert('dss_moora_ipa', $data);
        }

        redirect('IPAManagement/resultMoora', 'refresh');
    }

    public function resultTopsis()
    {
        $data['title'] = 'IPA Topsis Result';
        $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();

        $this->load->model('Topsis_model');
        $data['data'] = $this->Topsis_model->getJoinIpa();

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('template/topbar', $data);
        $this->load->view('ipa/result-topsis', $data);
        $this->load->view('template/footer');
    }
    ...
    public function getResultTopsis()
    {
        ...
        $this->db->empty_table('dss_topsis_ipa');
        ...
        foreach ($alternative->result() as $v) {
            ...
            $this->db->insert('dss_topsis_ipa', $data);
        }

        redirect('IPAManagement/resultTopsis', 'refresh');
    }
}
