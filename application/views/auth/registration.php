<div class="container">
    ...
    <div class="card o-hidden border-0 shadow-lg my-5 col-lg-7 mx-auto">
        <!--mx-auto digunakan untuk margin kiri kanan rata -->
                ...
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('auth/registration'); ?>">
                            <!-- Action mengarahkan ke Controller Auth.php dan memanggil Method registration -->
                            <!-- Atribute value="<= set_value('name'); >" digunakan untuk mempopulasi ulang form-->
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="name" name="name" placeholder="Full Name" value="<?= set_value('name'); ?>">
                                <?= form_error('name', '<small class="text-danger pl-3">', '</small>'); ?>
                                <!--Pemberitahuan ketika terdapat Error pada Colum Full Name -->
                            </div>
                            <div class="form-group">
                        ...
                        <div class="text-center">
                            ...
                            <!--Fungsi untuk Link menuju Controller Auth.php dan menjalankan Method Index -->
                        </div>
                    </div>
                </div>
            </div>
